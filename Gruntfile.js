module.exports = function(grunt) {
    grunt.initConfig({
        ...
        concat: {
            ...
            css: {
                src: ['src/assets/css/bootstrap.min.css', 'src/assets/css/bootstrap-theme.min.css', 'src/assets/css/font-awesome.min.css', 'src/assets/css/angular-busy.min.css', 'src/assets/css/style.css'],
                dest: 'build/assets/css/main.css',
            },
            app:{
                src:['src/assets/js/jquery.min.js', 'src/assets/js/bootstrap.min.js', 'src/assets/js/angular.min.js','src/assets/js/angular-route.min.js', 'src/app/app.js', 'src/app/factories/*.js', 'src/app/controllers/**/*.js'],
                dest:'build/app.js'
            }
        },
        uglify: {
